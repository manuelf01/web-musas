...
INSERT INTO `producto` (`idProducto`,`idCategoria`,`nombre`,`descripcion`,`precio`,`existencias`,`imagen`,`destacado`,`nota`,`activo`) VALUES
  (1,1,'Simple de Pollo','Hamburguesa de pollo con papas y tu salsa a elección.',7.00,30,NULL,NULL,NULL,1),
  (2,1,'Simple de Carne','Hamburguesa de carne con papas y tu salsa a elección.',8.50,30,NULL,NULL,NULL,1),
  ...
  (6,2,'Carne con Huevo','Hamburguesa de carne con huevo frito, papas y tu salsa a elección.',10.50,30,NULL,NULL,NULL,1),
  ...
  (12,3,'Carne, Huevo y Tocino','Hamburguesa de carne con huevo y tocino, papas y tu salsa a elección.',12.50,25,NULL,NULL,NULL,1),
  ...
  (15,4,'Carne, Queso, Jamón y Piña','Hamburguesa hawaiana de carne con queso, jamón y piña, papas y tu salsa a elección.',14.50,25,NULL,NULL,NULL,1),
  ...
  (21,5,'Carne, Huevo y Plátano','Hamburguesa a lo pobre de carne con huevo y plátano frito, papas y tu salsa a elección.',12.50,25,NULL,NULL,NULL,1),
  ...
  (27,7,'A lo Pobre Especial Pollo','Pollo deshilachado, huevo, plátano, queso, jamón y hot dog.',17.00,15,NULL,NULL,NULL,1),
  ...
  (31,8,'Salchipapa','Papas fritas con hot dog y ensalada.',12.00,25,NULL,NULL,NULL,1),
  (32,8,'Pollipapa','Papas fritas con presa de pollo y ensalada.',13.00,25,NULL,NULL,NULL,1),
  (33,8,'Salchipollo','Papas fritas con presa de pollo, ensalada y hot dog.',15.00,20,NULL,NULL,NULL,1),
  (34,8,'Salchitodo','Chorizo parrillero, huevo, queso, hot dog ahumado, pollo deshilachado, ensalada y papas.',18.00,15,NULL,NULL,NULL,1),
  (35,8,'Salchimusas','Papas, ensalada, chorizo parrillero, hot dog ahumado, tocino y queso derretido. Para 2 personas.',27.00,10,NULL,NULL,NULL,1),
  (36,9,'Combo Salchimusas','1 Salchimusas + 2 Chicha Morada.',30.00,10,NULL,NULL,NULL,1),
  (37,10,'Chicha Morada Natural','500 ml hecha con 100% ingredientes naturales, sin saborizantes ni preservantes.',3.00,50,NULL,NULL,NULL,1),
  (38,10,'Agua San Carlos','Agua San Carlos 500 ml.',2.00,50,NULL,NULL,NULL,1),
  (39,10,'Coca-Cola','Coca-Cola 600 ml.',4.00,50,NULL,NULL,NULL,1),
  (40,10,'Inca Kola','Inca Kola 600 ml.',4.00,50,NULL,NULL,NULL,1),
