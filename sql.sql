...
CREATE TABLE producto (
  ...
  existencias int unsigned DEFAULT 0 NOT NULL,
  imagen      varchar(255),
...
CREATE TABLE registroPedido (
  ...
  keyPedido        varchar(64) NOT NULL,
  PRIMARY KEY (idPedido),
  UNIQUE KEY uq_registroPedido_keyPedido (keyPedido),
  KEY idx_registroPedido_fechaPedido (fechaPedido),
  KEY idx_registroPedido_estadoRecojo (estadoRecojo));
CREATE TABLE usuario (
  ...
  intentosFallidos tinyint unsigned DEFAULT 0 NOT NULL,
  bloqueadoHasta datetime,
  bloqueoPermanente tinyint(1) DEFAULT 0 NOT NULL,
